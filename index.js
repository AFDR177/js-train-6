...
function printProductDetails(obj) {
  // Використовуємо деструктуризацію для отримання значень productName, price i також значень companyName,
  // country вкладеного об'єкту manufacturer
  const {
    productName,
    price,
...
newArr.customProperty = "myProperty";
